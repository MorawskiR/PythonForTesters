...
print(" ", wyniki_zbiory[0] & wyniki_zbiory[1] & wyniki_zbiory[2]) # (**)
slownikBledow={
'400' : 'Bad Request',# '401' : 'Unauthorized', # Świadomie pominięty!
'408' : 'Request Timeout',
'410' : 'Gone',
...
# Analiza danych (w tym miejscu wprowadzono drobne zmiany w porównaniu z pierwotnym kodem
# znanym z analizaWWW.py):
print("Lista wszystkich wykrytych błędów:")
