...
if len(sys.argv) !=4:
    ...
    print("Do widzenia!")
    exit() # Zakończ działanie skryptu i wróć do systemu operacyjnego!
    # W tym miejscu wiemy, że skrypt ma już poprawną liczbę parametrów (3), sprawdźmy teraz ich
# wartości. W tym celu wykorzystamy pożyteczną metodę 'find' zawartą w klasie <str>.
# find(s) zwraca indeks pierwszego wystąpienia napisu 's' w badanym ciągu znaków lub
# wartość –1 w przeciwnym razie
...
# Czy trzeci parametr to liczba? (N, gdzie 1<=N<=1)?
